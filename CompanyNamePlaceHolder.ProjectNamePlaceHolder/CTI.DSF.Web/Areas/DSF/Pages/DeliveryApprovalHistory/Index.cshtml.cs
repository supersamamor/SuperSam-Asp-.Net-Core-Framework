...
{   
    ...
    {        
        return await BatchUploadAsync<IndexModel, DeliveryApprovalHistoryState>(BatchUpload.BatchUploadForm, nameof(DeliveryApprovalHistoryState), "Index");
    }

    public IActionResult OnPostDownloadTemplate()
    {
        ModelState.Clear();
		BatchUpload.BatchUploadFileName = ExcelService.ExportTemplate<DeliveryApprovalHistoryState>(_uploadPath + "\\" + WebConstants.ExcelTemplateSubFolder);
