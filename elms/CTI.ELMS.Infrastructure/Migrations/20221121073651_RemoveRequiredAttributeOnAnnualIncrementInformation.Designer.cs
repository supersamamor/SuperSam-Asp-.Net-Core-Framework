...
namespace CTI.ELMS.Infrastructure.Migrations
{
    ...
    [Migration("20221121073651_RemoveRequiredAttributeOnAnnualIncrementInformation")]
    partial class RemoveRequiredAttributeOnAnnualIncrementInformation
    {
            ...
            modelBuilder.Entity("CTI.ELMS.Core.ELMS.LeadState", b =>
                {
                    ...
                    b.Property<string>("LatestUpdatedByUsername")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CTI.ELMS.Core.ELMS.OfferingState", b =>
                {
                    ...
                    b.Property<string>("LeaseContractStatus")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("CTI.ELMS.Core.ELMS.UnitOfferedState", b =>
                {
                    ...
                    b.Property<bool>("HasAnnualIncrement")
                        .HasColumnType("bit");
