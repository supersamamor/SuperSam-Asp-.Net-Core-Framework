...
public class ApplicationContext : AuditableDbContext<ApplicationContext>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
		...
		modelBuilder.Entity<OfferingState>().Property(e => e.OfferingHistoryID).HasMaxLength(450);
		modelBuilder.Entity<OfferingState>().HasIndex(p => p.OfferingHistoryID);
		...
		modelBuilder.Entity<UnitState>().Property(e => e.Location).HasMaxLength(255);
		modelBuilder.Entity<UnitState>().Property(e => e.UnitType).HasMaxLength(255);
