...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetIFCAARLedgerQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetIFCAARLedgerQuery>(nameof(IFCAARLedgerState.Id)));
