...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetReportTableYTDExpirySummaryQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetReportTableYTDExpirySummaryQuery>(nameof(ReportTableYTDExpirySummaryState.Id)));
