...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetUnitGroupQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetUnitGroupQuery>(nameof(UnitGroupState.Id)));
