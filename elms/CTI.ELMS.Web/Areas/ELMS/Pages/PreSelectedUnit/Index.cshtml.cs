...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetPreSelectedUnitQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetPreSelectedUnitQuery>(nameof(PreSelectedUnitState.Id)));
