...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetLeadTaskClientFeedBackQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetLeadTaskClientFeedBackQuery>(nameof(LeadTaskClientFeedBackState.Id)));
