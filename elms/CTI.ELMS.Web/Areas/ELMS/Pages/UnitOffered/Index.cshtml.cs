...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetUnitOfferedQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetUnitOfferedQuery>(nameof(UnitOfferedState.Id)));
