...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetIFCATransactionTypeQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetIFCATransactionTypeQuery>(nameof(IFCATransactionTypeState.Id)));
