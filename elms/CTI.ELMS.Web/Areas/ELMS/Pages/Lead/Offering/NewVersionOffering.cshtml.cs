...
[Authorize(Policy = Permission.Offering.CreateNewVersion)]
public class NewVersionOfferingModel : BasePageModel<NewVersionOfferingModel>
{
    private readonly OfferingServices _offeringServices;
    public NewVersionOfferingModel(OfferingServices offeringServices)
    {
