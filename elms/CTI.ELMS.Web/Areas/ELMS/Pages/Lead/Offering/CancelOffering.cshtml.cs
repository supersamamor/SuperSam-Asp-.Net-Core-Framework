...
[Authorize(Policy = Permission.Offering.CancelOffersheet)]
public class CancelOfferingModel : BasePageModel<CancelOfferingModel>
{
    [BindProperty]
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        return await TryThenRedirectToPage(async () => await Mediatr.Send(Mapper.Map<CancelOfferingCommand>(Offering)), "EditOffering", true);
    }
}
