...
namespace CTI.ELMS.Web.Areas.ELMS.Pages.Lead.LeaseContract;

[Authorize(Policy = Permission.Offering.View)]
public class LeaseContractListModel : BasePageModel<LeaseContractListModel>
{
    ...
    {
        LeadId = leadId;
        LeadTabNavigation = Mapper.Map<LeadTabNavigationPartial>(await Mediatr.Send(new GetTabNavigationByLeadIdQuery(leadId, Constants.TabNavigation.LeaseContract)));
        return Page();
    }
