...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetReportTableCollectionDetailQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetReportTableCollectionDetailQuery>(nameof(ReportTableCollectionDetailState.Id)));
