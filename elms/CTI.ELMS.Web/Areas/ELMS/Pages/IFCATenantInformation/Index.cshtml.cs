...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetIFCATenantInformationQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetIFCATenantInformationQuery>(nameof(IFCATenantInformationState.Id)));
