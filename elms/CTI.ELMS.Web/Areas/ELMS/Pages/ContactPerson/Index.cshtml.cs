...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetContactPersonQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetContactPersonQuery>(nameof(ContactPersonState.Id)));
