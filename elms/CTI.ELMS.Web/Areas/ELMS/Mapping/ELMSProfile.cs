...
public class ELMSProfile : Profile
{
    public ELMSProfile()
    {
		...
		CreateMap<UnitBudgetState, UnitBudgetViewModel>().ForPath(e => e.ForeignKeyUnit, o => o.MapFrom(s => s.Unit!.Id)).ForPath(e => e.ForeignKeyProject, o => o.MapFrom(s => s.Project!.Id)).ForPath(e => e.ForeignKeyUnitBudget, o => o.MapFrom(s => s.UnitBudget!.Id));
		...
		CreateMap<LeadTaskNextStepState, LeadTaskNextStepViewModel>().ForPath(e => e.ForeignKeyClientFeedback, o => o.MapFrom(s => s.ClientFeedback!.ClientFeedbackName)).ForPath(e => e.ForeignKeyNextStep, o => o.MapFrom(s => s.NextStep!.NextStepTaskName)).ForPath(e => e.ForeignKeyLeadTask, o => o.MapFrom(s => s.LeadTask!.LeadTaskName));
		...
		CreateMap<LeadState, LeadViewModel>().ForPath(e => e.ForeignKeyLeadSource, o => o.MapFrom(s => s.LeadSource!.LeadSourceName)).ForPath(e => e.ForeignKeyLeadTouchPoint, o => o.MapFrom(s => s.LeadTouchPoint!.LeadTouchPointName)).ForPath(e => e.ForeignKeyOperationType, o => o.MapFrom(s => s.OperationType!.OperationTypeName)).ForPath(e => e.ForeignKeyBusinessNatureSubItem, o => o.MapFrom(s => s.BusinessNatureSubItem!.Id)).ForPath(e => e.ForeignKeyBusinessNatureCategory, o => o.MapFrom(s => s.BusinessNatureCategory!.Id)).ForPath(e => e.ForeignKeyBusinessNature, o => o.MapFrom(s => s.BusinessNature!.BusinessNatureCode));
		...
		CreateMap<ContactPersonState, ContactPersonViewModel>().ForPath(e => e.ForeignKeyLead, o => o.MapFrom(s => s.Lead!.Id)).ForPath(e => e.ForeignKeySalutation, o => o.MapFrom(s => s.Salutation!.SalutationDescription));
		...
		CreateMap<ActivityState, ActivityViewModel>().ForPath(e => e.ForeignKeyNextStep, o => o.MapFrom(s => s.NextStep!.NextStepTaskName)).ForPath(e => e.ForeignKeyProject, o => o.MapFrom(s => s.Project!.Id)).ForPath(e => e.ForeignKeyLead, o => o.MapFrom(s => s.Lead!.Id)).ForPath(e => e.ForeignKeyLeadTask, o => o.MapFrom(s => s.LeadTask!.LeadTaskName)).ForPath(e => e.ForeignKeyClientFeedback, o => o.MapFrom(s => s.ClientFeedback!.ClientFeedbackName));
		...
		CreateMap<ActivityHistoryState, ActivityHistoryViewModel>().ForPath(e => e.ForeignKeyActivity, o => o.MapFrom(s => s.Activity!.Id)).ForPath(e => e.ForeignKeyClientFeedback, o => o.MapFrom(s => s.ClientFeedback!.ClientFeedbackName)).ForPath(e => e.ForeignKeyNextStep, o => o.MapFrom(s => s.NextStep!.NextStepTaskName)).ForPath(e => e.ForeignKeyLeadTask, o => o.MapFrom(s => s.LeadTask!.LeadTaskName));
		...
		CreateMap<UnitActivityState, UnitActivityViewModel>().ForPath(e => e.ForeignKeyActivityHistory, o => o.MapFrom(s => s.ActivityHistory!.Id)).ForPath(e => e.ForeignKeyUnit, o => o.MapFrom(s => s.Unit!.Id)).ForPath(e => e.ForeignKeyActivity, o => o.MapFrom(s => s.Activity!.Id));
		...
		CreateMap<OfferingState, OfferingViewModel>().ForPath(e => e.ForeignKeyLead, o => o.MapFrom(s => s.Lead!.Id)).ForPath(e => e.ForeignKeyProject, o => o.MapFrom(s => s.Project!.Id));
		...
		CreateMap<OfferingHistoryState, OfferingHistoryViewModel>().ForPath(e => e.ForeignKeyOffering, o => o.MapFrom(s => s.Offering!.Id)).ForPath(e => e.ForeignKeyProject, o => o.MapFrom(s => s.Project!.Id)).ForPath(e => e.ForeignKeyLead, o => o.MapFrom(s => s.Lead!.Id));
		...
		CreateMap<UnitOfferedState, UnitOfferedViewModel>().ForPath(e => e.ForeignKeyOffering, o => o.MapFrom(s => s.Offering!.Id)).ForPath(e => e.ForeignKeyUnit, o => o.MapFrom(s => s.Unit!.Id));
		...
		CreateMap<UnitOfferedHistoryState, UnitOfferedHistoryViewModel>().ForPath(e => e.ForeignKeyOffering, o => o.MapFrom(s => s.Offering!.Id)).ForPath(e => e.ForeignKeyUnit, o => o.MapFrom(s => s.Unit!.Id)).ForPath(e => e.ForeignKeyOfferingHistory, o => o.MapFrom(s => s.OfferingHistory!.Id));
		...
		CreateMap<IFCATenantInformationState, IFCATenantInformationViewModel>().ForPath(e => e.ForeignKeyProject, o => o.MapFrom(s => s.Project!.Id)).ForPath(e => e.ForeignKeyOffering, o => o.MapFrom(s => s.Offering!.Id));
		...
		CreateMap<IFCAUnitInformationState, IFCAUnitInformationViewModel>().ForPath(e => e.ForeignKeyIFCATenantInformation, o => o.MapFrom(s => s.IFCATenantInformation!.Id)).ForPath(e => e.ForeignKeyUnit, o => o.MapFrom(s => s.Unit!.Id));
		...
		CreateMap<ReportTableCollectionDetailState, ReportTableCollectionDetailViewModel>().ForPath(e => e.ForeignKeyIFCATenantInformation, o => o.MapFrom(s => s.IFCATenantInformation!.Id)).ForPath(e => e.ForeignKeyProject, o => o.MapFrom(s => s.Project!.Id));
