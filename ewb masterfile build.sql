...
USE FAS
--GO
--INSERT [dbo].[DatabaseConnectionSetup] ([Id], [Code], [Name], [DatabaseAndServerName], [InhouseDatabaseAndServerName], [SystemConnectionString], [IsDisabled], [Entity], [CreatedBy], [CreatedDate], [LastModifiedBy], [LastModifiedDate]) VALUES (N'1', N'IFCA-FAIV2', N'FAI V2', N'[FAIALA-ID1].[FAI_PPlusLive_V2].[mgr]', N'[FAIALA-ID1].[SDG_PplusLive].[sdgadmin]', N'', 0, N'DEFAULT', N'System', CAST(N'2020-02-23T02:53:08.3100000' AS DateTime2), N'System', CAST(N'2020-02-23T02:53:08.3100000' AS DateTime2))
--INSERT [dbo].[DatabaseConnectionSetup] ([Id], [Code], [Name], [DatabaseAndServerName], [InhouseDatabaseAndServerName], [SystemConnectionString], [IsDisabled], [Entity], [CreatedBy], [CreatedDate], [LastModifiedBy], [LastModifiedDate]) VALUES (N'2', N'IFCA-FAIV3', N'FAI V3', N'[FAIALA-ID1].[FAI_PPlusLive_V3].[mgr]', N'[FAIALA-ID1].[SDG_PplusLive_V3].[sdgadmin]', NULL, 1, N'DEFAULT', N'System', CAST(N'2020-02-23T02:53:08.3100000' AS DateTime2), N'89dcc2a6-8e8d-4d35-aa75-147d276766c7', CAST(N'2022-11-27T14:09:17.0326728' AS DateTime2))
...
--INSERT [dbo].[DatabaseConnectionSetup] ([Id], [Code], [Name], [DatabaseAndServerName], [InhouseDatabaseAndServerName], [SystemConnectionString], [IsDisabled], [Entity], [CreatedBy], [CreatedDate], [LastModifiedBy], [LastModifiedDate]) VALUES (N'4', N'IFCA-FAIV3_1', N'FAI V3.1', N'[FAIALA-ID1].[FAI_PPlusV3_1_Live].[mgr]', 1, N'', 0, N'DEFAULT', N'System', CAST(N'2021-11-24T10:20:26.0170000' AS DateTime2), N'System', CAST(N'2021-11-24T10:20:26.0170000' AS DateTime2))
