...
using ProjectNamePlaceHolder.Services.Domain.Common.Events;
...
namespace ProjectNamePlaceHolder.Services.Infrastructure.Persistence.Repositories
{
    /// <summary>
    ...
    public class EventAddingRepositoryDecorator<T> : IRepositoryWithEvents<T>
        where T : class, IHasDomainEvent, IAggregateRoot
    {
