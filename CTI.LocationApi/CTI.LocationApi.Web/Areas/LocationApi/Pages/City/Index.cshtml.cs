...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetCityQuery>());
        return new JsonResult(result.Data
            .Select(e => new
            {
                e.Id,
                ProvinceId = e.Province?.Code,
				e.Code,
				e.Name,
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetCityQuery>(nameof(CityState.Code)));
