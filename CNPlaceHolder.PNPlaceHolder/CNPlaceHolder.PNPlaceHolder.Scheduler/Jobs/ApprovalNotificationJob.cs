...
using Quartz;
using CNPlaceHolder.Common.Services.Shared.Interfaces;
using CNPlaceHolder.Common.Services.Shared.Models.Mail;

namespace CNPlaceHolder.PNPlaceHolder.Scheduler.Jobs
{
    ...
    public class ApprovalNotificationJob : IJob
    {
        ...
        private string SetApprovalUrl(string message, ApprovalRecordState approvalRecord)
        {
            ...
            {
                message = message.Replace(EmailContentPlaceHolder.ApprovalUrl, $"{_baseUrl}/PNPlaceHolder/{approvalRecord!.ApproverSetup!.TableName}/Approve?Id={approvalRecord.DataId}");
            }
            return message;
        }
