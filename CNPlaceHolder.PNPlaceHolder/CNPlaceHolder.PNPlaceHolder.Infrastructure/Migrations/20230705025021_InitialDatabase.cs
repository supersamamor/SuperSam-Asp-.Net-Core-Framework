    ...
    public partial class InitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TnamePlaceHolder", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TnamePlaceHolder_Colname",
                table: "TnamePlaceHolder",
                column: "Colname",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TnamePlaceHolder_Entity",
                table: "TnamePlaceHolder",
                column: "Entity");

            migrationBuilder.CreateIndex(
                name: "IX_TnamePlaceHolder_LastModifiedDate",
                table: "TnamePlaceHolder",
