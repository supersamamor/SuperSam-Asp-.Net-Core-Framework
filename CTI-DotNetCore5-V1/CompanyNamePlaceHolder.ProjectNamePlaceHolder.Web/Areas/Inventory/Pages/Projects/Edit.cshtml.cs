...
using CompanyNamePlaceHolder.ProjectNamePlaceHolder.Application.Inventory.Projects.Queries;
    ...
    public class EditModel : BasePageModel<EditModel>
    {
        ...
        public async Task<IActionResult> OnGetDetailsAsync(string? id)
        {
            ...
            return await Mediatr.Send(new GetProjectByIdQuery(id))
                                .ToActionResult(e => Partial("_EditProjectDetails",
                                                             Mapper.Map<ProjectViewModel>(e)), none: null);
        }
        ...
        public async Task<IActionResult> OnPostEditAsync()
        {
            ...
            {
                return Partial("_EditProjectDetails", Project);
            }
            var result = await TryAsync(async () => await Mediatr.Send(Mapper.Map<EditProjectCommand>(Project)))
                .IfFail(ex =>
                {
