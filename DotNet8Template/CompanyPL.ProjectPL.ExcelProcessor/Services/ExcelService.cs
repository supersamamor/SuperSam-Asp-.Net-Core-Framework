...
using CompanyPL.ProjectPL.ExcelProcessor.CustomValidation;

namespace CompanyPL.ProjectPL.ExcelProcessor.Services
{
        ...
        private async Task<Dictionary<string, object?>> CustomValidationPerRecordHandler(string module, Dictionary<string, object?> rowValue)
        {
            ...
            switch (module)
            {
				...
				case nameof(HealthDeclarationState):
					return await HealthDeclarationValidator.ValidatePerRecordAsync(_context, rowValue);
