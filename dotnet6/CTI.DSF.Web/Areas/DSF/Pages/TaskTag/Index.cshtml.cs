...
{   
    ...
    {        
        return await BatchUploadAsync<IndexModel, TaskTagState>(BatchUpload.BatchUploadForm, nameof(TaskTagState), "Index");
    }

    public IActionResult OnPostDownloadTemplate()
    {
        ModelState.Clear();
		BatchUpload.BatchUploadFileName = ExcelService.ExportTemplate<TaskTagState>(_uploadPath + "\\" + WebConstants.ExcelTemplateSubFolder);
