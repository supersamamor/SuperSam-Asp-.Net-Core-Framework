...
{   
    ...
    {        
        return await BatchUploadAsync<IndexModel, TeamState>(BatchUpload.BatchUploadForm, nameof(TeamState), "Index");
    }

    public IActionResult OnPostDownloadTemplate()
    {
        ModelState.Clear();
		BatchUpload.BatchUploadFileName = ExcelService.ExportTemplate<TeamState>(_uploadPath + "\\" + WebConstants.ExcelTemplateSubFolder);
