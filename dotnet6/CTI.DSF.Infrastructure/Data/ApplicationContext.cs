...
public class ApplicationContext : AuditableDbContext<ApplicationContext>
{
	...
	public DbSet<TaskMasterState> TaskMaster { get; set; } = default!;
	public DbSet<TaskCompanyAssignmentState> TaskCompanyAssignment { get; set; } = default!;
	...
	public DbSet<DeliveryApprovalHistoryState> DeliveryApprovalHistory { get; set; } = default!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
		...
		modelBuilder.Entity<TaskMasterState>().HasQueryFilter(e => _authenticatedUser.Entity == Core.Constants.Entities.Default.ToUpper() || e.Entity == _authenticatedUser.Entity);
		modelBuilder.Entity<TaskCompanyAssignmentState>().HasQueryFilter(e => _authenticatedUser.Entity == Core.Constants.Entities.Default.ToUpper() || e.Entity == _authenticatedUser.Entity);
		...
		modelBuilder.Entity<DeliveryApprovalHistoryState>().HasQueryFilter(e => _authenticatedUser.Entity == Core.Constants.Entities.Default.ToUpper() || e.Entity == _authenticatedUser.Entity);
		...
		modelBuilder.Entity<CompanyState>().Property(e => e.Active).HasMaxLength(450);
		modelBuilder.Entity<DepartmentState>().Property(e => e.DepartmentCode).HasMaxLength(450);
		modelBuilder.Entity<DepartmentState>().Property(e => e.Active).HasMaxLength(450);
		modelBuilder.Entity<SectionState>().Property(e => e.SectionCode).HasMaxLength(450);
		modelBuilder.Entity<SectionState>().Property(e => e.Active).HasMaxLength(450);
		modelBuilder.Entity<TeamState>().Property(e => e.TeamCode).HasMaxLength(450);
		modelBuilder.Entity<TeamState>().Property(e => e.Active).HasMaxLength(450);
		...
		modelBuilder.Entity<TaskMasterState>().Property(e => e.TaskDescription).HasMaxLength(255);
		modelBuilder.Entity<TaskMasterState>().Property(e => e.Active).HasMaxLength(450);
		modelBuilder.Entity<TaskApproverState>().Property(e => e.ApproverUserId).HasMaxLength(450);
		modelBuilder.Entity<AssignmentState>().Property(e => e.AssignmentCode).HasMaxLength(450);
		modelBuilder.Entity<AssignmentState>().Property(e => e.PrimaryAssignee).HasMaxLength(450);
		modelBuilder.Entity<AssignmentState>().Property(e => e.AlternateAssignee).HasMaxLength(450);
		modelBuilder.Entity<DeliveryState>().Property(e => e.DeliveryCode).HasMaxLength(450);
		modelBuilder.Entity<DeliveryState>().Property(e => e.Status).HasMaxLength(50);
		modelBuilder.Entity<DeliveryState>().Property(e => e.SubmittedBy).HasMaxLength(450);
		modelBuilder.Entity<DeliveryState>().Property(e => e.ReviewedBy).HasMaxLength(450);
		modelBuilder.Entity<DeliveryState>().Property(e => e.ApprovedBy).HasMaxLength(450);
		modelBuilder.Entity<DeliveryState>().Property(e => e.RejectedBy).HasMaxLength(450);
		modelBuilder.Entity<DeliveryState>().Property(e => e.CancelledBy).HasMaxLength(450);
		modelBuilder.Entity<DeliveryApprovalHistoryState>().Property(e => e.Status).HasMaxLength(50);
		modelBuilder.Entity<DeliveryApprovalHistoryState>().Property(e => e.TransactedBy).HasMaxLength(450);
		...
		modelBuilder.Entity<TaskMasterState>().HasMany(t => t.TaskCompanyAssignmentList).WithOne(l => l.TaskMaster).HasForeignKey(t => t.TaskMasterId);
		modelBuilder.Entity<CompanyState>().HasMany(t => t.TaskCompanyAssignmentList).WithOne(l => l.Company).HasForeignKey(t => t.CompanyId);
		modelBuilder.Entity<DepartmentState>().HasMany(t => t.TaskCompanyAssignmentList).WithOne(l => l.Department).HasForeignKey(t => t.DepartmentId);
		modelBuilder.Entity<SectionState>().HasMany(t => t.TaskCompanyAssignmentList).WithOne(l => l.Section).HasForeignKey(t => t.SectionId);
		modelBuilder.Entity<TeamState>().HasMany(t => t.TaskCompanyAssignmentList).WithOne(l => l.Team).HasForeignKey(t => t.TeamId);
		modelBuilder.Entity<TaskCompanyAssignmentState>().HasMany(t => t.TaskApproverList).WithOne(l => l.TaskCompanyAssignment).HasForeignKey(t => t.TaskCompanyAssignmentId);
		modelBuilder.Entity<TaskMasterState>().HasMany(t => t.TaskTagList).WithOne(l => l.TaskMaster).HasForeignKey(t => t.TaskMasterId);
		modelBuilder.Entity<TagsState>().HasMany(t => t.TaskTagList).WithOne(l => l.Tags).HasForeignKey(t => t.TagId);
		modelBuilder.Entity<TaskCompanyAssignmentState>().HasMany(t => t.AssignmentList).WithOne(l => l.TaskCompanyAssignment).HasForeignKey(t => t.TaskCompanyAssignmentId);
		modelBuilder.Entity<TaskCompanyAssignmentState>().HasMany(t => t.DeliveryList).WithOne(l => l.TaskCompanyAssignment).HasForeignKey(t => t.TaskCompanyAssignmentId);
		modelBuilder.Entity<AssignmentState>().HasMany(t => t.DeliveryList).WithOne(l => l.Assignment).HasForeignKey(t => t.AssignmentId);
		modelBuilder.Entity<DeliveryState>().HasMany(t => t.DeliveryApprovalHistoryList).WithOne(l => l.Delivery).HasForeignKey(t => t.DeliveryId);
