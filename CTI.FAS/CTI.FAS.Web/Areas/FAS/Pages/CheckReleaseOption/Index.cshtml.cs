...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetCheckReleaseOptionQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetCheckReleaseOptionQuery>(nameof(CheckReleaseOptionState.Id)));
