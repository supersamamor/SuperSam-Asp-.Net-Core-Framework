...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetCreditorEmailQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetCreditorEmailQuery>(nameof(CreditorEmailState.Id)));
