...
public class EditModel : BasePageModel<EditModel>
{
    ...
    {		
        ...
        return await TryThenRedirectToPage(async () => await Mediatr.Send(Mapper.Map<EditScheduleFrequencyParameterSetupCommand>(ScheduleFrequencyParameterSetup)), "Details", true);
    }	
