...
namespace CTI.SQLReportAutoSender.Scheduler.Jobs
{
    public class ApprovalNotificationJob : IJob
    {
        ...
        private string SetApprovalUrl(string message, ApprovalRecordState approvalRecord)
        {
            ...
            {
                message = message.Replace(EmailContentPlaceHolder.ApprovalUrl, $"{_baseUrl}/SQLReportAutoSender/{approvalRecord!.ApproverSetup!.TableName}/Approve?Id={approvalRecord.DataId}");
            }
            return message;
        }
