...
using CHANGE_TO_APP_NAME.Services.Application.Common.Security;
using CHANGE_TO_APP_NAME.Services.Application.TodoLists.Commands.CreateTodoList;
using CHANGE_TO_APP_NAME.Services.Application.TodoLists.Commands.PurgeTodoLists;
using CHANGE_TO_APP_NAME.Services.Application.TodoLists.Queries.ExportTodos;
...
namespace CHANGE_TO_APP_NAME.Services.Application.IntegrationTests.TodoLists.Commands
{
