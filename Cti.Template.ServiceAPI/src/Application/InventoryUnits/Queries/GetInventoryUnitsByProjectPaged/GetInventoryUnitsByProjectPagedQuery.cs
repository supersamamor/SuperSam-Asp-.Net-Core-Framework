...
using CHANGE_TO_APP_NAME.Services.Application.Common.Extensions;
...
namespace CHANGE_TO_APP_NAME.Services.Application.InventoryUnits.Queries.GetInventoryUnitsByProjectPaged
{
