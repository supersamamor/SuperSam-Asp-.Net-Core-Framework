...
namespace ProjectNamePlaceHolder.Data.Migrations
{
    public partial class InitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProjectNamePlaceHolderApiClient",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectNamePlaceHolderApiClient", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ProjectNamePlaceHolderUser",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectNamePlaceHolderUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectNamePlaceHolderUser_AspNetUsers_IdentityId",
