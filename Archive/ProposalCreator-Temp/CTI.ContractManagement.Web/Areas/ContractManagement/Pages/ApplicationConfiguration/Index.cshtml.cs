...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetApplicationConfigurationQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetApplicationConfigurationQuery>(nameof(ApplicationConfigurationState.Id)));
