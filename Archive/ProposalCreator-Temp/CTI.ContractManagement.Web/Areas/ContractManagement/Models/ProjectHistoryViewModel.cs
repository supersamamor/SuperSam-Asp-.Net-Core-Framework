...
{	
	...
	public string? GeneratedLogoPath
	{
		get
		{
			return this.LogoForm?.FileName == null ? this.Logo : "\\" + WebConstants.ProjectHistory + "\\" + this.Id + "\\" + nameof(this.Logo) + "\\" + this.LogoForm!.FileName;
		}
	}
	[Display(Name = "Goals")]
	[Required]
	...
	public IList<ProjectMilestoneHistoryViewModel>? ProjectMilestoneHistoryList { get; set; }
	public IList<ProjectPackageHistoryViewModel>? ProjectPackageHistoryList { get; set; }
