...
public class EditModel : BasePageModel<EditModel>
{
    ...
    {		
        ...
        return await TryThenRedirectToPage(async () => await Mediatr.Send(Mapper.Map<EditTaskApproverCommand>(TaskApprover)), "Details", true);
    }	
	public IActionResult OnPostChangeFormValue()
    {
        ModelState.Clear();
		
        return Partial("_InputFieldsPartial", TaskApprover);
    }
