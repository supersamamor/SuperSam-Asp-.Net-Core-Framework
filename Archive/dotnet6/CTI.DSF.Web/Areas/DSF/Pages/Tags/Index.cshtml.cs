...
{   
    ...
    {        
        return await BatchUploadAsync<IndexModel, TagsState>(BatchUpload.BatchUploadForm, nameof(TagsState), "Index");
    }

    public IActionResult OnPostDownloadTemplate()
    {
        ModelState.Clear();
		BatchUpload.BatchUploadFileName = ExcelService.ExportTemplate<TagsState>(_uploadPath + "\\" + WebConstants.ExcelTemplateSubFolder);
