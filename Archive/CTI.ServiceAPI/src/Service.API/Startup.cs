...
using ProjectNamePlaceHolder.Services.Application;
using ProjectNamePlaceHolder.Services.Infrastructure;
...
using ProjectNamePlaceHolder.Services.API.Helpers;
using ProjectNamePlaceHolder.Services.API.Services;
