...
using ProjectNamePlaceHolder.Application.Features.Products.Commands.Delete;
using ProjectNamePlaceHolder.Application.Features.Products.Queries.Export;
using ProjectNamePlaceHolder.Application.Features.Products.Queries.GetAllPaged;
using ProjectNamePlaceHolder.Application.Features.Products.Queries.GetProductImage;
using ProjectNamePlaceHolder.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Threading.Tasks;

namespace ProjectNamePlaceHolder.Server.Controllers.v1.Catalog
{
