...
using ProjectNamePlaceHolder.Application.Features.ExtendedAttributes.Commands.Delete;
...
using ProjectNamePlaceHolder.Application.Features.ExtendedAttributes.Queries.GetById;
using ProjectNamePlaceHolder.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace ProjectNamePlaceHolder.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
