...
using ProjectNamePlaceHolder.Application.Specifications.ExtendedAttribute;
...
namespace ProjectNamePlaceHolder.Application.Features.ExtendedAttributes.Queries.Export
{
