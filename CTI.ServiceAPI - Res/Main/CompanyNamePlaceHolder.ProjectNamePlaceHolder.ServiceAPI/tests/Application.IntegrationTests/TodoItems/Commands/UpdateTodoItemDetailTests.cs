...
using CHANGE_TO_APP_NAME.Services.Application.TodoItems.Commands.UpdateTodoItem;
using CHANGE_TO_APP_NAME.Services.Application.TodoItems.Commands.UpdateTodoItemDetail;
...
using CHANGE_TO_APP_NAME.Services.Domain.Enums;
