...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetPurchaseRequisitionQuery>());
        return new JsonResult(result.Data
            .Select(e => new
            {
                e.Id,
                DateRequired = e.DateRequired.ToString("MMM dd, yyyy"),
				e.Purpose,
				e.Remarks,
				e.Status,
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetPurchaseRequisitionQuery>(nameof(PurchaseRequisitionState.Id)));
