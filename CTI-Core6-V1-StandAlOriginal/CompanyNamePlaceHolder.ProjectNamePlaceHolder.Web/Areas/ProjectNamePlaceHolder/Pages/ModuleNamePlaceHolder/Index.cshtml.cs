...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    {
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetModuleNamePlaceHolderQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetModuleNamePlaceHolderQuery>(nameof(ModuleNamePlaceHolderState.Code)));
