...
namespace CTI.TenantSales.Scheduler.Repository.SalesFileProcessing
{
    ...
    public class SalesProcessingRepository 
    {
        private readonly ApplicationContext _context;
        private readonly ILogger<SalesProcessingRepository> _logger;
        ...
        public SalesProcessingRepository(ApplicationContext context, ILogger<SalesProcessingRepository> logger, SalesFileHelper salesFileHelper,
        ...
        public async Task ProcessSalesFile()
        {
        ...
        public async Task TenantSalesValidate(DateTime? _salesDate = null, string? projectId = null, string? tenantId = null)
        {
        ...
        {
            var query = _context.Project.Where(l => l.IsDisabled == false
        ...
        private async Task<TenantPOSSalesState?> GetPOSSalesId(string posId, int salesType, DateTime salesDate, string salesCategory)
        {
            return await _context.TenantPOSSales.Where(l => l.TenantPOSId == posId
                    ...
                    && l.SalesCategory == salesCategory).AsNoTracking().IgnoreQueryFilters().FirstOrDefaultAsync();
        }
        ...
        private async Task<IList<TenantState>> GetActiveTenants(string projectId, string? tenantId)
        {
            ...
            return await query.Include(l => l.TenantPOSList).Include(l => l.SalesCategoryList).IgnoreQueryFilters().ToListAsync();
        }
