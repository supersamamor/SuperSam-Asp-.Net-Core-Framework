...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetCategoryQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetCategoryQuery>(nameof(CategoryState.Id)));
