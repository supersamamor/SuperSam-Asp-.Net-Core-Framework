...
public class IndexModel : BasePageModel<IndexModel>
{
    ...
    public async Task<IActionResult> OnPostListAllAsync()
    {
        ...
        var result = await Mediatr.Send(DataRequest!.ToQuery<GetClassificationQuery>());
    ...
    {
        var result = await Mediatr.Send(request.ToQuery<GetClassificationQuery>(nameof(ClassificationState.Id)));
