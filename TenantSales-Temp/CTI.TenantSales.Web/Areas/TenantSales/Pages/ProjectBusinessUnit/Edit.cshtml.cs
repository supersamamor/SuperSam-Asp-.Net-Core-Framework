...
public class EditModel : BasePageModel<EditModel>
{
    ...
    {		
        ...
        return await TryThenRedirectToPage(async () => await Mediatr.Send(Mapper.Map<EditProjectBusinessUnitCommand>(ProjectBusinessUnit)), "Details", true);
    }	
	public IActionResult OnPostChangeFormValue()
    {
        ModelState.Clear();
		
        return Partial("_InputFieldsPartial", ProjectBusinessUnit);
    }
