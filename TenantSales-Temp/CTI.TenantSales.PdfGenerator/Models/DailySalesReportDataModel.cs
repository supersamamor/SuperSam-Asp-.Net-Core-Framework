namespace CTI.TenantSales.PdfGenerator.Models
{
    ...
    {
        public DailySalesModel(DateTime dateFrom, DateTime dateTo, IList<TenantDailySales> tenantDailySales)
        {
            this.DateFrom = dateFrom;
            this.DateTo = dateTo;
            this.TenantDailySales = tenantDailySales;        
        }
        public DateTime DateFrom { get; set; }
        public DateTime DateTo { get; set; }
        public IList<TenantDailySales> TenantDailySales { get; set; }
    }
